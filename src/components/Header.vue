<template>
  ...
  >
    <div class="container" style="max-width: 1110px;">
        ...
        <div class="col">
          <div class="header__mobile-menu d-flex d-sm-none">
            ...
            <div class="header__menu-mobile-wrap">
              ...
              <nav class="header__mobile-menu-nav" :class="{ active: isMobileMenuOpen }">
      ...
      <div class="header__overlay" :class="{ active: isMobileMenuOpen }" @click="closeMobileMenu"></div>
    </div>
      ...
      <div class="modal-cart" @click.stop>
        ...
        <div v-else>
          <div class="modal-cart__item" v-for="item in cartItems" :key="item.id">
            <div>
              <img :src="getImagePath(item.image)" :alt="item.name" class="modal-cart__cart-image">
              <h3>{{ item.name }}</h3>
              <p>{{ item.author }}</p>
...
//   // Не дублируем логику — просто вызываем из composable
...
// }
  ...
  //   return new URL(`../assets/images/catalog/${imageName}.jpg`,
  ...
  //         break
  //       case 'filled':
  //         fileName = 'basket-active.svg';
  //         break
  //       case 'focus':
  //         fileName = 'basket-focus.svg';
  //         break
  //       case 'hover':
  //         fileName = 'basket-hover.svg';
  //         break
  //       default:
  //         fileName = 'basket.svg'
  //     }
  //     const fullPath = new URL(basePath + fileName,
  //       import.meta.url).href
  ...
  // const images =
  //   import.meta.glob('@/assets/images/header/*.{png,svg,jpg,jpeg}', {
  //     eager: true
  //   })
